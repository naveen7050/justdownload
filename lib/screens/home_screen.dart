                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      runSpacing: 8,
                      children: const [
                        _PlatformChip(label: 'YouTube', icon: Icons.play_circle_fill_rounded, color: Color(0xFFFF0000)),
                        _PlatformChip(label: 'Instagram', icon: Icons.camera_alt_rounded, color: Color(0xFFE4405F)),
                        _PlatformChip(label: 'Facebook', icon: Icons.facebook_rounded, color: Color(0xFF1877F2)),
                        _PlatformChip(label: 'TikTok', icon: Icons.music_note_rounded, color: Color(0xFF00F2EA)),
                        _PlatformChip(label: 'Twitter/X', icon: Icons.tag_rounded, color: Color(0xFF8899AA)),
                      ],
                    ),
                  ],
                ),
